...
.date-requested, .date-accomplished{
  min-width: 80px !important;
}

.end-user, .accomplisher{
  min-width: 130px;
}
...
.date-requested, .date-accomplished{
  ...
  <body>
    ...
    <div class="summary__canvas">
      ...
      <div class="summary__content">
        ...
        <table id="print-table">
          <thead>
            ...
            <th rowspan="2" class="end-user">END USER</th>
            <th rowspan="2">CATEGORY</th>
            <th rowspan="2">SUBCATEGORY</th>
            <th colspan="2">DATE</th>
            <th rowspan="2" class="accomplisher">ACCOMPLISHED BY</th>
            </tr>

            <tr>
              <th class="date-requested">REQUESTED</th>
              <th class="date-accomplished">ACCOMPLISHED</th>
            </tr>
          </thead>
          <tbody>
            </tbody>
        ...
        <br>
        <div class="row2" style="width: 550px; align-self: start; margin-bottom: 30px;">
          <span style="margin-right: 275px;">Prepared by:</span> <span>Reviewed by:</span>
        </div>


        <div class="row2" style="width: 550px; align-self: start;">
          <span style="margin-right: 140px;">______________________________</span><span>______________________________</span>
        </div>
        <div class="row2 row--space-between" style="width: 540px; align-self: start;">
          <b style="margin-left: 45px;">NAME & POSITION</b>
      ...
      <a href="/report?staff=<?php echo $_GET['staff']?>&slip_status=<?php echo $_GET['slip_status'] ?>&category=<?php echo $_GET['category'] ?>&month=<?php echo $_GET['month'] ?>" class="button2 button--color" id="back-btn">Back</a>
      </div>
    </div>
    <script>
